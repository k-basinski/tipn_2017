...
## Zadanie 2-4
Zrób jeszcze raz zadanie 2-3, tym razem używając pętli `while` i funkcji `readline()`, aby wczytać dowolny rok rozpoczęcia listy.
...
```
Podpowiedzi:
  - zdefiniuj funkcję `narysuj_galaz(jak_daleko_od_pnia, igla = "#")`
